...
`,j0=["js","php","py"];function F(t,r){const e={xor:{js:h0,php:m0,py:k0},rc4:{js:w0,php:g0,py:S0},aes:{js:_0,php:v0,py:B0}},x=e[t]||e.xor;return x[r]||x.js}const C0={class:"tool-panel"},O0={class:"tool-header"},X0={class:"tool-title"},R0={class:"tool-desc"},E0={class:"toolbar"},P0=["placeholder"],A0={key:0,class:"key-hint"},K0={class:"output-box"},V0={key:0,class:"output-inner"},T0={class:"crypto-output"},I0={key:1,class:"empty-hint"},N0={class:"code-section"},U0={class:"code-header"},H0={class:"code-title"},L0={class:"code-tabs"},F0=["onClick"],D0={class:"code-body"},M0=["innerHTML"],J0={__name:"CryptoTool",setup(t){const r=v("xor"),e=v(""),x=v(""),o=v(""),i=v(""),n=v(""),c=v("js"),{show:y}=i0(),u=E(()=>c.value==="js"?"js":c.value==="php"?"php":"python"),k=E(()=>F(r.value,c.value)),w=E(()=>c0(k.value,u.value));x0(r,()=>{c.value="js",l("","")});function l(g,$){i.value=g,n.value=$||""}function h(){return e.value.trim()?!0:(l(a("crypto.emptyKey"),"err"),!1)}function Y(){if(x.value&&h())try{o.value=y0(r.value,x.value,e.value),l(a("crypto.encryptDone"),"ok")}catch(g){o.value="",l(g.message||String(g),"err")}}function z(){if(x.value&&h())try{o.value=p0(r.value,x.value.trim(),e.value),l(a("crypto.decryptDone"),"ok")}catch(g){o.value="",l(g.message||String(g),"err")}}function G(){x.value="",o.value="",e.value="",l("","")}async function Q(){await H(o.value)&&y(a("common.copied"))}async function W(){await H(F(r.value,c.value))&&y(a("common.copied"))}return(g,$)=>(S(),_("div",C0,[s("div",O0,[s("div",X0,b(d(a)("tools.crypto.name")),1),s("div",R0,b(d(a)("tools.crypto.desc")),1)]),s("div",E0,[T(s("select",{"onUpdate:modelValue":$[0]||($[0]=p=>r.value=p),class:"algo-select"},[...$[3]||($[3]=[s("option",{value:"xor"},"XOR + Base64",-1),s("option",{value:"rc4"},"RC4",-1),s("option",{value:"aes"},"AES-128-CBC",-1)])],512),[[e0,r.value]]),T(s("input",{"onUpdate:modelValue":$[1]||($[1]=p=>e.value=p),placeholder:d(a)("crypto.keyPlaceholder"),class:"key-input",type:"text",spellcheck:"false"},null,8,P0),[[t0,e.value]]),s("button",{class:"primary",onClick:Y},b(d(a)("crypto.encrypt")),1),s("button",{onClick:z},b(d(a)("crypto.decrypt")),1),$[4]||($[4]=s("span",{class:"spacer"},null,-1)),s("button",{onClick:G},"🗑 "+b(d(a)("common.clear")),1)]),r.value==="aes"?(S(),_("div",A0,"⚠️ "+b(d(a)("crypto.aesKeyHint")),1)):I("",!0),R(n0,{modelValue:x.value,"onUpdate:modelValue":$[2]||($[2]=p=>x.value=p),placeholder:d(a)("crypto.inputPlaceholder"),"min-height":"180px"},null,8,["modelValue","placeholder"]),i.value?(S(),_("div",{key:1,class:N(["status",n.value])},b(i.value),3)):I("",!0),s("div",K0,[o.value?(S(),_("div",V0,[R(L,{text:o.value,class:"crypto-lines"},{default:U(()=>[s("pre",T0,b(o.value),1)]),_:1},8,["text"]),s("button",{class:"copy-btn",onClick:Q},b(d(a)("common.copy")),1)])):(S(),_("div",I0,b(d(a)("common.result")),1))]),s("div",N0,[s("div",U0,[s("span",H0,"🧰 "+b(d(a)("crypto.codeTitle")),1),s("div",L0,[(S(!0),_(r0,null,o0(d(j0),p=>(S(),_("button",{key:p,class:N(["code-tab",{active:c.value===p}]),onClick:q0=>c.value=p},b(d(a)("crypto.lang."+p)),11,F0))),128))]),$[5]||($[5]=s("span",{class:"spacer"},null,-1)),s("button",{onClick:W},b(d(a)("common.copy")),1)]),s("div",D0,[R(L,{text:k.value,class:"code-lines"},{default:U(()=>[s("pre",{innerHTML:w.value},null,8,M0)]),_:1},8,["text"])])])]))}},Z0=Z(J0,[["__scopeId","data-v-10d2e022"]]);export{Z0 as default};
